...
module par_mod
  ...
  integer,parameter :: idiffnorm=3600, idiffmax=2*idiffnorm, minstep=1
...
integer,parameter :: nxmax=451,nymax=361,nuvzmax=152,nwzmax=152,nzmax=152
  ...
  integer,parameter :: maxageclass=7,nclassunc=1
